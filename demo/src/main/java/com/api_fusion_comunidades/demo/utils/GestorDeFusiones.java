...
public class GestorDeFusiones {
  public ContextoComunidadesDTO ejecutarFusiones(List<Comunidad> comunidades, List<Fusion> fusiones) {
    ...
    return new ContextoComunidadesDTO(nuevasComunidades, fusionesPropuestas);
  }
}
